        ...
        <div class="card">
            ...
            <Toolbar class="mb-4">
                <template #start>
                    ...
                    <Button label="Delete" icon="pi pi-trash" severity="danger" @click="confirmDeleteSelected" :disabled="!selectedClients || !selectedClients.length" />
                </template>
            ...
            <DataTable
                ...
                <Column header="Name" field="displayName" sortable style="min-width:16rem"></Column>
                <Column header="Company" field="company" sortable style="min-width:16rem"></Column>
                <Column header="Country" field="country.name" sortable style="min-width:16rem"></Column>
                <Column header="Reviews" field="rating" sortable style="min-width:12rem">
...
export default {
    ...
    mounted() {
        ...
        ProductService.getClients().then((data) => (this.clients = data));
    },
}
</script>
